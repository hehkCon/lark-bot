...
def get_performance_tracker():
    """Initialize and return PerformanceTracker with LarkBaseClient"""
    ...
    if event_type == "im.message.receive_v1":
        ...
        if text_lower == "perf help":
            try:
                ...
                user_data = performance_tracker.client.get_user_data_dict()
                help_handler = PerformanceCommands(performance_tracker, user_data)
